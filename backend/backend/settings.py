...
SECRET_KEY = "django-insecure-$i%8stg$9479_ke6b0ersxa#e*+&gm(%iq0och4wcrx0iv&nc-"

# SECURITY WARNING: don't run with debug turned on in production!
DEBUG = True

ALLOWED_HOSTS = ['localhost:5173', '127.0.0.1:8000', '127.0.0.1', 'localhost']
...
AUTHENTICATION_BACKENDS = (
    'app.authentication_backends.EmailAuthBackend',  # Use the custom email authentication
    'django.contrib.auth.backends.ModelBackend',  # Optional: fallback to the default backend
    'social_core.backends.google.GoogleOAuth2',
    'django.contrib.auth.backends.ModelBackend',  # This is necessary for fallback
)
