# Generated by Django 5.1.4 on 2025-01-05 06:31
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('id', models.IntegerField(default=561445, editable=False, primary_key=True, serialize=False, unique=True)),
                ...
                ('medication', models.ManyToManyField(blank=True, related_name='medication', to='app.medication')),
            ],
            options={
                'verbose_name': 'user',
